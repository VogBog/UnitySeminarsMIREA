...
{
    public struct FirebaseSignInVoid
    {
        private readonly FirebaseSignInAsync _method;

        public FirebaseSignInVoid(FirebaseSignInAsync method)
        {
            _method = method;
        }
        ...
        public async void Response(Action<SignInResponse, UnityWebRequest.Result> onComplete)
        {
            try
            {
